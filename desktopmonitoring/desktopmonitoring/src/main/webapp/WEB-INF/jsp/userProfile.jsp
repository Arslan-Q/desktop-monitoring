								...
								<div class="card-body">
									<form action="${pageContext.request.contextPath}/profileUpdate"
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Deparment</label> <select
														required="required" class="form-control" name="department"
														="${rec.department}">
											...
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Password</label> <input
														type="text" name="user_password" class="form-control"
														value="${rec.user_password}">
												</div>
											</div>
											<div class="col-md-4">
												<div class="form-group">
													<label class="bmd-label-floating">Contact No#</label> <input
														type="text" name="contact_no" class="form-control"
														value="${rec.contact_no}">
												</div>
											</div>
							...
							<div class="card card-profile">
								<div class="card-avatar">
									<a href="#pablo"> <img class="img"
										src="user_panal/assets/img/faces/marc.jpg" />
									</a>
								</div>
								<div class="card-body">
